...
const Product = ({ product, id}: Props) => {
  ...
  const addItemToBasket = () => {
    ...
    toast.success(`${product.title} has been successfully added to basket.`, {
  ...
  return (
    ...
    <div className="flex justify-center p-5">
      ...
      <div  className="flex gap-5 justify-center">
        ...
        <div onClick={addItemToBasket} className="shoppingIcon h-[50px] w-[50px] p-3 cursor-pointer text-white bg-gradient-to-r from-pink-500 to-violet-500 rounded-full">
          <ShoppingCartIcon/>
        </div>
      </div>
    </div>
